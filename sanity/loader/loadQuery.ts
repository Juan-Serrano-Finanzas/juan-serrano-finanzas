...
export function loadSettings() {
  return loadQuery<SettingsPayload>(
    settingsQuery,
    {},
    { next: { tags: ['settings', 'home', 'page', 'book', 'project'] } }
  )
}
...
export function loadFinancePage() {
  return loadQuery<FinancePagePayload | null>(
    financePageQuery,
    {},
    { next: { tags: [`finance`] } }
  )
...
export function loadInternationalStockMarketPage() {
  return loadQuery<InternationalStockMarketPagePayload | null>(
    internationalStockMarketPageQuery,
    {},
    { next: { tags: [`market-international`] } }
  )
}
export function loadSpanishStockMarketPage() {
  return loadQuery<SpanishStockMarketPagePayload | null>(
    spanishStockMarketPageQuery,
    {},
    { next: { tags: [`market-spanish`] } }
  )
}
